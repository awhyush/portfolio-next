    ...
    <footer className="mt-auto border-t border-border pt-20 pb-10 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-24 relative z-10">
        <div className="md:col-span-2">
          ...
          <p className="text-subtle max-w-xs leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-6 border-t border-border pt-8 flex flex-col md:flex-row items-center justify-between text-subtle text-[10px] uppercase tracking-widest">
        <p>
